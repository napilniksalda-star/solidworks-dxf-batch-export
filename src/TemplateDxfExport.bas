...
'
'  2. ТАБЛИЦА ПАРАМЕТРОВ — столбцы:
'       • размеры детали по полному имени размера, напр.:
'           D1@Эскиз1   D2@Эскиз1   D2@Базовая кромка1   Толщина@Листовой металл
'       • количество и прочие НЕразмерные данные — как СВОЙСТВО, с префиксом:
'           $PRP@Количество        (в рус. интерфейсе:  $СВОЙСТВО@Количество)
